...
--     }
-- automate() function
-- automate : Address -> Call ()
-- automate contractAddress =
--     { to = Just contractAddress
--     , from = Nothing
--     , gas = Nothing
--     , gasPrice = Nothing
--     , value = Nothing
--     , data = Just <| E.functionCall "049aacfe" []
--     , nonce = Nothing
...
--         |> toElmDecoder
-- execute(address,bytes) function
-- execute : Address -> Address -> Hex -> Call Hex
-- execute contractAddress target_ data_ =
--     { to = Just contractAddress
--     , from = Nothing
--     , gas = Nothing
--     , gasPrice = Nothing
--     , value = Nothing
--     , data = Just <| E.functionCall "1cff79cd" [ E.address target_, E.bytes data_ ]
--     , nonce = Nothing
...
--     , decoder = toElmDecoder D.uint
--     }
-- getMinRedemptionRatio() function
-- getMinRedemptionRatio : Address -> Call BigInt
-- getMinRedemptionRatio contractAddress =
--     { to = Just contractAddress
--     , from = Nothing
--     , gas = Nothing
--     , gasPrice = Nothing
--     , value = Nothing
--     , data = Just <| E.functionCall "58846c42" []
--     , nonce = Nothing
--     , decoder = toElmDecoder D.uint
--     }
-- getRatio() function
...
-- Issued(address,uint256,uint256,uint256,uint256) event
-- type alias Issued =
--     { receiver : Address
...
--     , toBlock = LatestBlock
--     , address = contractAddress
--     , topics = [ Just <| U.unsafeToHex "374a351db3f664ea453a7ce5668a042151e5aac07bf62f30d35defd0a019b0be" ]
--     }
...
--         |> custom (topic 1 D.address)
-- Redeemed(address,address,uint256,uint256,uint256,uint256) event
-- type alias Redeemed =
--     { redeemer : Address
--     , receiver : Address
--     , tokensRedeemed : BigInt
--     , fee : BigInt
--     , totalCollateralFreed : BigInt
--     , collateralReturned : BigInt
--     }
...
--     , toBlock = LatestBlock
--     , address = contractAddress
--     , topics = [ Just <| U.unsafeToHex "9098b5d2df18e362430218b79a4098cb0081120ca9fa44e94891dcbefe5204de" ]
--     }
